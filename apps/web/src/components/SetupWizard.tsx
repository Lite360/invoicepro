...
export const SetupWizard: React.FC<SetupWizardProps> = ({ onComplete, existingCompany }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 py-12">
      <div className="max-w-4xl w-full bg-white border border-slate-200 rounded-3xl shadow-xl overflow-hidden">
        {/* Banner Header */}
        <div className="bg-[#0F9D58] p-8 text-white relative overflow-hidden">
        ...
        {/* Form Body */}
        <form onSubmit={handleSubmit} className="p-8 space-y-8 text-slate-800">
          {/* Step 1: Basic Details & Contact */}
          <div className="space-y-4">
            <div className="flex items-center space-x-2 text-[#0F9D58] font-bold text-base border-b border-slate-100 pb-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-[#0F9D58] text-slate-900"
                />
              </div>
              <div>
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-600 mb-1">Tax Number (Optional)</label>
                <input
                  type="text"
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="p-4 bg-slate-50 border border-slate-200 rounded-2xl text-center">
                <label className="block text-xs font-semibold text-slate-600 mb-2">Business Logo</label>
                {formData.logoUrl ? (
                  <div className="relative group mb-2">
                    <img src={formData.logoUrl} alt="Logo" className="h-16 mx-auto object-contain bg-white rounded-lg p-1 border border-slate-200" />
                    <span className="text-[10px] text-[#0F9D58] font-medium block mt-1">✓ Uploaded</span>
                  </div>
                ) : (
                  <div className="h-16 border-2 border-dashed border-slate-300 rounded-xl flex items-center justify-center text-slate-500 text-xs mb-2">
                ...
                <label
                  htmlFor="logo-upload"
                  className="inline-block px-3 py-1.5 bg-[#0F9D58] hover:bg-[#0B7A44] text-white text-xs font-medium rounded-lg cursor-pointer transition"
                >
                  Upload Logo
                </label>
              </div>
              ...
              {/* Watermark Upload */}
              <div className="p-4 bg-slate-50 border border-slate-200 rounded-2xl text-center">
                <label className="block text-xs font-semibold text-slate-600 mb-2">Watermark Logo</label>
                {formData.watermarkUrl ? (
                  <div className="relative group mb-2">
                    <img src={formData.watermarkUrl} alt="Watermark" className="h-16 mx-auto object-contain bg-white rounded-lg p-1 border border-slate-200" />
                    <span className="text-[10px] text-[#0F9D58] font-medium block mt-1">✓ Uploaded</span>
                  </div>
                ) : (
                  <div className="h-16 border-2 border-dashed border-slate-300 rounded-xl flex items-center justify-center text-slate-500 text-xs mb-2">
              ...
              <div className="p-4 bg-slate-50 border border-slate-200 rounded-2xl text-center">
                <label className="block text-xs font-semibold text-slate-600 mb-2">Digital Signature</label>
                {formData.signatureUrl ? (
                  <div className="relative group mb-2">
                    <img src={formData.signatureUrl} alt="Signature" className="h-16 mx-auto object-contain bg-white rounded-lg p-1 border border-slate-200" />
                    <span className="text-[10px] text-[#0F9D58] font-medium block mt-1">✓ Uploaded</span>
                  </div>
                ) : (
                  <div className="h-16 border-2 border-dashed border-slate-300 rounded-xl flex items-center justify-center text-slate-500 text-xs mb-2">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-600 mb-1">Secondary Accent</label>
                <input
                  type="color"
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-600 mb-1">Quotation Prefix</label>
                <input
                  type="text"
          ...
          <div className="pt-4 border-t border-slate-100 flex justify-end">
            <button
              type="submit"
              disabled={loading}
              className="flex items-center space-x-2 px-8 py-3.5 bg-[#0F9D58] hover:bg-[#0B7A44] text-white font-bold rounded-xl shadow-xl shadow-[#0F9D58]/30 transition-all text-sm"
            >
